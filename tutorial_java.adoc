...
The book recommendation service initialization is shown below (from link:https://github.com/CloudI/cloudi_tutorial_java/blob/v2.0.4/src/main/java/org/cloudi/examples/tutorial/Service.java#L88-L138[Service.java:88-138^]):
...
An example of a service request handling function is below (using the "itemRefresh" function from link:https://github.com/CloudI/cloudi_tutorial_java/blob/v2.0.4/src/main/java/org/cloudi/examples/tutorial/Service.java#L166-L212[Service.java:166-212^]):
...
[[{prefix, "/tutorial/java/service/"},
  ...
  {args, "-Dfile.encoding=UTF-8 "
         ...
         "-ea:org.cloudi... "
         "-Xms3g -Xmx3g "
         "-jar $PWD/target/cloudi_tutorial_java-2.0.4-jar-with-dependencies.jar "
...
The table above shows the service subscriptions that occur during service initialization (in link:https://github.com/CloudI/cloudi_tutorial_java/blob/v2.0.4/src/main/java/org/cloudi/examples/tutorial/Service.java#L88-L138[Service.java:88-138^]).
...
The Javascript interface relies on a WebSocket connection for any usage of the REST API as shown below (link:https://github.com/CloudI/cloudi_tutorial_java/blob/v2.0.4/html/tutorial/java/index.html#L542-L550[index.html:542-550^]):
...
The service request handler function "client" is shown below (from link:https://github.com/CloudI/cloudi_tutorial_java/blob/v2.0.4/src/main/java/org/cloudi/examples/tutorial/Service.java#L385-L508[Service.java:385-508^]):
...
For scheduling an interrupt of the `poll` function the timeout parameter is used as shown below (from link:https://github.com/CloudI/cloudi_tutorial_java/blob/v2.0.4/src/main/java/org/cloudi/examples/tutorial/Service.java#L139-L144[Service.java:139-144^]):
